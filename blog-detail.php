              ...
              <div class="top"> <!-- top -->
                  <div class="container">
                      <ul class="top-support"> 
                          ...
                          <li><a href=""><i class="fa fa-envelope-square"></i><span>info@arjun.com</span></a></li>
                      </ul>
                              ...
                              <!-- <div class="container-fluid"> -->
                                  ...
                                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                      <ul class="nav navbar-nav">
                                          <li><a href="product.php">Home <span class="sr-only">(current)</span></a></li>
                                          <li><a href="blog.php">Blog</a></li>
                                          <li class="active"><a href="blog-detail.php">Blog Post</a></li>
              ...
              <div class="container">
                  <nav class="navbar navbar-default">
                      ...
                      <div class="collapse navbar-collapse" id="cat-nav-mega">
                          <ul class="nav navbar-nav">
                              <li class="active"><a href="product.php">ELECTRONICS </a></li>
                              <li class="dropdown menu-large">
                                  <a href="men.php">MEN </a>

                              <li><a href="blog.php">WOMEN </a></li>
                              <li><a href="contact.php">BABY & KIDS </a></li>
                              <li><a href="contact.php">BOOKS & MEDIA </a></li>
                              <li><a href="contact.php">HOME & KITCHEN </a></li>
                              <li><a href="contact.php">MORE STORES </a></li>
                      ...
                      <div class="row">
                          <div class="col-md-3">
                              <div class="text-widget">
                                  ...
                                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeTgqVozZ2-D6mepTDaoQw2LfVc222sRZ0dQ&s" alt="ft-logo">
                                  <p>
