...
<script>/
  ...
  fetch("http://localhost/Online_shopping/admin/women_read.php").then(
    res => {
      res.json().then(
        data => {
          if(data.data.length > 0){
            ...
            data.data.forEach((itemData)=>{
              temp+="<div class='col-md-3 prdct-grid'><div class='product-fade'><div class='product-fade-wrap'><div  class='owl-carousel owl-theme'><div class='item'></div></div><img  src='./fold/"+itemData.image2+"'><div class='product-fade-ct'><div class='product-fade-control'></i></a><a href=''><div class='clearfix'></div><a href='cart.php?id="+itemData.id+"' class='btn btn-to-cart'><span class='bag'></span><span>Add To cart</span><div class='clearfix'></div></a></div></div></div></div><div class='product-name'><a href='view.php?id='>"+itemData.product_name+"</a></div><div class='star-1'></div><div class='product-price'><span>$"+itemData.mrp+"</span> $"+itemData.sales_rate+"</div></div></div>";
            });
              // console.log(temp);
                              ...
                              <!-- <div class="container-fluid"> -->
                                  ...
                                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                      ...
                                      <ul class="nav navbar-nav navbar-right">
                                          ...
                                          <li><a href="cart.php"><span>2</span></a></li>
